...
**-**Our plot shows that there is a positive relationship between popularity and vote_count.
...
**-** The $P-value$ = 2e-16 is less than 0.05(default value). This shows that our model fits the data. However, Our model does not explain much of the variation of the data because of the low Adjusted R-squared of 0.08059 and $P-value$ but it is significant(It is better than not to have a model).
...
Yes, it does help me understand the podcast especially when the guest talked about keeping tracks of things and managing and monitoring models. 

2. How do you think the ideas of ML OPs will affect your future data science projects?  

#Ans

Things are really moving fast with AI and I think that the idea of MLops with definitely have a huge impact in the way data science is seen and practiced in the future. There are so many unresolved issues that requires solution and this will bring about the change in the way data science in practiced and what their job requirement will entail. 
